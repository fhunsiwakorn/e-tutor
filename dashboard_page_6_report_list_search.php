...
?>
       <tr>
          ...
          <td  align="center">
            <div class="btn-group">
            <button type="button"  class="btn btn-default" onclick="window.location.href='report-excel?us=<?php echo $rowList['user_id']; ?>&C=<?php echo $rowList['type_id'];?>'" data-toggle="tooltip" title="<?=$col4?> <?php echo $rowList['user_firstname'];?> <?php echo $rowList['user_lastname'];?>">
            <img id="myImg"  src="image_system/Microsoft-Excel-2013-Logo.png"  width="25" height="25" >
            </button>
            <button type="button"  class="btn btn-default" onclick="window.location.href='report-word?us=<?php echo $rowList['user_id']; ?>&C=<?php echo $rowList['type_id'];?>'" data-toggle="tooltip" title="<?=$col4?> <?php echo $rowList['user_firstname'];?> <?php echo $rowList['user_lastname'];?>">
            <img id="myImg"  src="image_system/logo_word.png"  width="25" height="25" >
            </button>
            <button type="button"  class="btn btn-default" onclick="window.open('report-print?us=<?php echo $rowList['user_id']; ?>&C=<?php echo $rowList['type_id'];?>', '_blank');" />
