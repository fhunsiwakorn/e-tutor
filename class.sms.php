...
$texttitle="$URL";
$tel=$_POST['user_tel'];
$usertext="User: ".$_POST['user_name'];
$passtext="Pass: ".$_POST['user_password'];
$evd = DateThai($d); ///วันหมดอายุ
$strDate = DateThai($strNewDate); ///วันหมดอายุ
$texday="ใช้ได้ถึงวันที่"."$strDate";
$textALL="($texttitle)"."($usertext)"."($passtext)"."$texday";
/////////////////////
$sms = new thsms();

$sms->username   = 'SiwakornDev';
$sms->password   = '9194cf';

$a = $sms->getCredit();
var_dump( $a);

$b = $sms->send( '0000', $tel, $textALL);
var_dump( $b);
