...
");
				...
				<section class="content">
					...
					if (!isset($_GET["option"])) {
						...
						switch ($_GET['option']) {
							case "exam-course":
								include("dashboard_page_2_exam.php");
								break;
							case "exam-data":
								include("dashboard_page_3_exam_data.php");
								break;
							case "student-data":
								include("dashboard_page_4_student_data.php");
								break;
							case "student-edit":
								include("dashboard_page_5_student_edit.php");
								break;
							case "report":
								include("dashboard_page_6_report_list.php");
								break;
							case "report-chart":
								include("dashboard_page_7_report_chart.php");
								break;
							case "student-report-chart":
								include("dashboard_page_11_student_list_report.php");
								break;
							case "student-renew":
								include("dashboard_page_12_student_renew.php");
								break;
							default:
								include("dashboard_page_1_home.php");
						}
