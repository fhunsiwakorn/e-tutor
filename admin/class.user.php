...
class USER
{
	...
	public function doLogin($uname,$umail,$upass)
	{
		try
		{
			$stmt = $this->conn->prepare("SELECT user_id, user_name,user_password,user_status FROM user_member_group WHERE user_name=:uname AND user_status=:user_status");
			$stmt->execute(array(':uname'=>$uname, ':user_status'=>3));
