...
$sth->execute(
 ...
 echo "<script>";
 echo "location.href = 'dashboard_admin?option=student-data&success'";
 echo "</script>";
        }else {
          echo "<script>";
...
if(isset($_GET['del']) && isset($_GET['Selectuser_id'])){
  ...
  $sth->execute(
   ...
   echo "<script>";
   echo "location.href = 'dashboard_admin?option=student-data&success-d'";
   echo "</script>";
  }
      }catch(PDOException $e) {
          echo $e->getMessage();
...
if(isset($_GET['update']) && isset($_GET['Selectuser_id'])){
  ...
  $sth->execute(
   ...
   echo "<script>";
   echo "location.href = 'dashboard_admin?option=student-data&success-u'";
   echo "</script>";
  }
      }catch(PDOException $e) {
          echo $e->getMessage();
...
function fncSubmit(strPage)
{
	if(strPage == "page1")
	{
		document.form1.action="dashboard_admin?option=student-data&del";
	}

	if(strPage == "page2")
	{
		document.form1.action="dashboard_admin?option=student-data&update";
	}
 ...
 <div class="col-xs-4">
    <form action="#" method="get"name="form1"  autocomplete="off">
        <div class="input-group">
          ...
          <button type="button" name="search" id="search-btn" onclick="window.location.href='dashboard_admin?option=student-data'" class="btn btn-flat"><i class="glyphicon glyphicon-refresh"></i>
                </button>
              </span>
        </div>
      </form>
